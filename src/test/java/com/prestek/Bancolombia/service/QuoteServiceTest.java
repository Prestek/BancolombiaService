...
class QuoteServiceTest {
    ...
    @Test
    @DisplayName("Should return bank code BANCOLOMBIA")
    void shouldReturnBankCodeBancolombia() {
        // When
        QuoteDto quote = quoteService.quote(testRequest);

        // Then
        assertThat(quote.institution()).isEqualTo("BANCOLOMBIA");
    }
    ...
    void shouldGenerateQuoteWithAppropriateRateForHighDTI() {
        ...
        assertThat(quote).isNotNull();
        assertThat(quote.aprEAEstimated()).isGreaterThan(0);
        // Bancolombia es sensible a DTI (wDTI = 0.40)
    }
    ...
    @Test
    @DisplayName("Should verify Bancolombia specific weights")
    void shouldVerifyBancolombiaSpecificWeights() {
        // Bancolombia tiene weights específicos:
        // Muy sensibles a DTI
